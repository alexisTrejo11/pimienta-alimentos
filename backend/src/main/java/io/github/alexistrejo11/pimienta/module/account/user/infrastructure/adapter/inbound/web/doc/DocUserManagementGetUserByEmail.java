...
/** {@code GET /api/v1/users/management/by-email} */
...
@Operation(
    ...
    description =
        "Looks up a user by email (normalized on the server). **404** if unknown.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocUserManagementGetUserByEmail {}
