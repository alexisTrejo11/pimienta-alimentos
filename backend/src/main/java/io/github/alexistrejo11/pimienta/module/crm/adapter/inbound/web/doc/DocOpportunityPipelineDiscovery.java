...
/** {@code POST /api/v1/opportunities/{id}/pipeline/discovery} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(
    summary = "Move opportunity to discovery",
    description = "Pipeline transition; domain rules apply (invalid state → **400**).")
@ApiResponse(
    responseCode = "200",
...
public @interface DocOpportunityPipelineDiscovery {}
