...
/** {@code POST /api/v1/opportunities/{id}/pipeline/proposal} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Send proposal", description = "Pipeline transition to proposal stage.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocOpportunityPipelineProposal {}
