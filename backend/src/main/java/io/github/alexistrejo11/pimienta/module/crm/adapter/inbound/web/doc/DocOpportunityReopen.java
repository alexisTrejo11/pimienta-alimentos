...
/** {@code POST /api/v1/opportunities/{id}/reopen} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Reopen opportunity", description = "Returns an opportunity to an open pipeline state when allowed.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocOpportunityReopen {}
