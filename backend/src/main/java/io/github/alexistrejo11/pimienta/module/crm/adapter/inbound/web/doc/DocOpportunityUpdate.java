...
/** {@code PATCH /api/v1/opportunities/{id}} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Update opportunity", description = "Partial update. **404** if not found.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocOpportunityUpdate {}
