...
/** {@code POST /api/v1/projects/{id}/activate} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Activate project", description = "Lifecycle: activate when allowed by domain.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocProjectActivate {}
