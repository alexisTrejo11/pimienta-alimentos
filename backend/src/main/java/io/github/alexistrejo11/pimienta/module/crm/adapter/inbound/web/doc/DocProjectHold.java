...
/** {@code POST /api/v1/projects/{id}/hold} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Put project on hold", description = "Requires `ReasonRequest` body with reason text.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocProjectHold {}
