...
/** {@code POST /api/v1/projects/{projectId}/milestones/{milestoneId}/billed} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Mark milestone billed", description = "Lifecycle: billed / invoiced state.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocProjectMilestoneBilled {}
