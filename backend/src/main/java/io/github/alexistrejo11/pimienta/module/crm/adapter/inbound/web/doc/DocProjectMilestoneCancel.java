...
/** {@code POST /api/v1/projects/{projectId}/milestones/{milestoneId}/cancel} */
...
@Operation(
    ...
    description = "Lifecycle: cancel. Rate limit: **SENSITIVE_OPERATIONS**.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocProjectMilestoneCancel {}
