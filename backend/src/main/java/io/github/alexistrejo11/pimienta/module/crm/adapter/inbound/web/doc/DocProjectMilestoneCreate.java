...
/** {@code POST /api/v1/projects/{projectId}/milestones} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Create milestone", description = "Creates a milestone under the project.")
@ApiResponse(
    responseCode = "201",
...
public @interface DocProjectMilestoneCreate {}
