...
/** {@code POST /api/v1/projects/{projectId}/milestones/{milestoneId}/delayed} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Mark milestone delayed", description = "Lifecycle: delayed state.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocProjectMilestoneDelayed {}
