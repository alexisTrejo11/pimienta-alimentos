...
/** {@code POST /api/v1/projects/{projectId}/milestones/{milestoneId}/start} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Start milestone", description = "Lifecycle: start work when domain allows.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocProjectMilestoneStart {}
