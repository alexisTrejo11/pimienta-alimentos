...
/** {@code PATCH /api/v1/projects/{projectId}/milestones/{milestoneId}} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Update milestone", description = "Partial update. **404** if not found.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocProjectMilestoneUpdate {}
