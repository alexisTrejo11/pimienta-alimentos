...
import io.github.alexistrejo11.pimienta.module.crm.adapter.out.persistence.specification.OpportunitySpecifications;
import io.github.alexistrejo11.pimienta.module.crm.adapter.out.persistence.mapper.OpportunityPersistenceMapper;
...
public class OpportunityRepositoryImpl implements OpportunityRepository {
  ...
  public Page<Opportunity> search(OpportunitySearchCriteria criteria, Pageable pageable) {
    OpportunitySearchCriteria effective = criteria != null ? criteria : OpportunitySearchCriteria.empty();
