...
import io.github.alexistrejo11.pimienta.module.crm.adapter.out.persistence.mapper.ProjectPersistenceMapper;
import io.github.alexistrejo11.pimienta.module.crm.adapter.out.persistence.model.ProjectJpaEntity;
import io.github.alexistrejo11.pimienta.module.crm.adapter.out.persistence.specification.ProjectSpecifications;
...
public class ProjectRepositoryImpl implements ProjectRepository {
  ...
  public long countActive() {
    return jpaRepository.countByDeletedAtIsNullAndStatus(ProjectStatus.ACTIVE);
  }
}
