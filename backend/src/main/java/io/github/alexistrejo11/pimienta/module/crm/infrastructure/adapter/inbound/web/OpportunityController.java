...
import io.github.alexistrejo11.pimienta.module.crm.core.application.OpportunityUseCases;
...
import io.github.alexistrejo11.pimienta.module.crm.infrastructure.adapter.inbound.web.dto.LoseOpportunityRequest;
...
public class OpportunityController {
  ...
  public PagedResponse<OpportunityResponse> searchOpportunities(
    ...
    Page<Opportunity> page =
        opportunityUseCases.search(criteria, PageRequest.of(filter.getPage(), filter.getSize()));
  ...
  public OpportunitySummaryResponse getOpportunitySummary(@PathVariable Long id) {
    return OpportunityWebMapper.toSummaryResponse(opportunityUseCases.getSummary(id));
  }
  ...
  public OpportunityResponse createOpportunity(@Valid @RequestBody CreateOpportunityRequest request) {
    Opportunity created =
        opportunityUseCases.create(OpportunityWebMapper.toCreateParams(request));
