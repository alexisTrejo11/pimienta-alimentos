...
/**
 * Factor de integración, clasificación IMSS y prestaciones legales
...
public record BenefitsProfile(
  ...
  public BenefitsProfile {
    ...
    vacationPremiumPercent = vacationPremiumPercent != null ? vacationPremiumPercent : DEFAULT_VACATION_PREMIUM_PERCENT;
  }
  ...
  /**
   * Salario Base de Cotización (SBC) diario = salario diario × factor de
   * integración.
   */
