...
/** {@code GET /api/v1/files/management/{id}/download-url} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(
    summary = "Generate download URL (admin)",
    description = "Returns a 24-hour pre-signed S3 URL for the given asset. **ROLE_ADMIN** only.")
...
public @interface DocFileManagementDownload {}
