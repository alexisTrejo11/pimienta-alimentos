...
/** {@code PUT /api/v1/inventory/items/{id}/activate} */
...
@Operation(
    ...
    description = "Reactiva un artículo descontinuado. Rate limit: **SENSITIVE_OPERATIONS**.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocInventoryItemActivate {}
