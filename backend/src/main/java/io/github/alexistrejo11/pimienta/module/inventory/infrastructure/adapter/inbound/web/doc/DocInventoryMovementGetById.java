...
/** {@code GET /api/v1/inventory/movements/{id}} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Parameter(name = "id", in = ParameterIn.PATH, required = true, example = "500")
@Operation(
    summary = "Get movement by id",
    description = "**404** (`INVENTORY_MOVEMENT_NOT_FOUND`). Rate limit: **READ_HEAVY**.")
@ApiResponse(
    responseCode = "200",
    content =
        @Content(
...
public @interface DocInventoryMovementGetById {}
