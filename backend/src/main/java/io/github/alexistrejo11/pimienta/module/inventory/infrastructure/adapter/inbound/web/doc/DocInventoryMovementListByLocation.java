...
/** {@code GET /api/v1/inventory/movements/location/{locationId}} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Parameter(name = "locationId", in = ParameterIn.PATH, required = true, example = "3")
@Operation(summary = "List movements by location", description = "Rate limit: **READ_HEAVY**.")
@ApiResponse(
    responseCode = "200",
    content =
        @Content(
...
public @interface DocInventoryMovementListByLocation {}
