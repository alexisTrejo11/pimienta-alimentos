...
/** {@code GET /api/v1/inventory/stock/out-of-stock} */
...
@Operation(
    summary = "List out-of-stock rows",
    description = "Existencias en cantidad cero. Rate limit: **READ_HEAVY**.")
@ApiResponse(
    responseCode = "200",
...
public @interface DocInventoryStockOut {}
