...
/** {@code POST /api/v1/inventory/transactions/{id}/cancel} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Parameter(name = "id", in = ParameterIn.PATH, required = true, description = "ID de transacción.", example = "100")
@Operation(summary = "Cancel transaction", description = "**204** sin cuerpo si ok. Rate limit: **SENSITIVE_OPERATIONS**.")
...
public @interface DocInventoryTransactionCancel {}
