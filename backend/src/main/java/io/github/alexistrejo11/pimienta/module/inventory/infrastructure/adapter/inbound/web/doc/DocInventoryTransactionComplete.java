...
/** {@code POST /api/v1/inventory/transactions/{id}/complete} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Parameter(name = "id", in = ParameterIn.PATH, required = true, description = "ID de transacción.", example = "100")
@Operation(summary = "Complete transaction", description = "Sin cuerpo. Rate limit: **SENSITIVE_OPERATIONS**.")
@ApiResponse(
    responseCode = "200",
    content =
        @Content(
...
public @interface DocInventoryTransactionComplete {}
