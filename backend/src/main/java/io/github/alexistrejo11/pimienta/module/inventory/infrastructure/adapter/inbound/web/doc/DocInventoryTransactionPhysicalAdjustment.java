...
/** {@code POST /api/v1/inventory/transactions/physical-adjustment} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(
    summary = "Register physical count adjustment",
    description = "Cuerpo JSON **PhysicalAdjustmentTransactionRequest**. Rate limit: **SENSITIVE_OPERATIONS**.")
@RequestBody(
    required = true,
    content =
        @Content(
            mediaType = "application/json",
            schema = @Schema(implementation = PhysicalAdjustmentTransactionRequest.class)))
@ApiResponse(
    responseCode = "200",
    content =
        @Content(
...
public @interface DocInventoryTransactionPhysicalAdjustment {}
