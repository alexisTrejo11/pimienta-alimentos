...
/** {@code POST /api/v1/inventory/transactions/sale} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Register sale transaction", description = "Cuerpo JSON **SaleTransactionRequest**. Rate limit: **SENSITIVE_OPERATIONS**.")
@RequestBody(
    required = true,
    content =
        @Content(
            mediaType = "application/json",
            schema = @Schema(implementation = SaleTransactionRequest.class)))
@ApiResponse(
    responseCode = "200",
    content =
        @Content(
...
public @interface DocInventoryTransactionSale {}
