...
/** {@code POST /api/v1/inventory/transactions/scrap} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Operation(summary = "Register scrap transaction", description = "Cuerpo JSON **ScrapTransactionRequest**. Rate limit: **SENSITIVE_OPERATIONS**.")
@RequestBody(
    required = true,
    content =
        @Content(
            mediaType = "application/json",
            schema = @Schema(implementation = ScrapTransactionRequest.class)))
@ApiResponse(
    responseCode = "200",
    content =
        @Content(
...
public @interface DocInventoryTransactionScrap {}
