...
/** {@code POST /api/v1/inventory/transactions/{id}/submit} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Parameter(name = "id", in = ParameterIn.PATH, required = true, description = "ID de transacción.", example = "100")
@Operation(summary = "Submit transaction for approval", description = "Sin cuerpo. Rate limit: **SENSITIVE_OPERATIONS**.")
@ApiResponse(
    responseCode = "200",
    content =
        @Content(
...
public @interface DocInventoryTransactionSubmit {}
