...
/** {@code PUT /api/v1/inventory/locations/{id}/unblock} */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@DocJwtSecured
@Parameter(name = "id", in = ParameterIn.PATH, required = true, example = "2")
@Operation(summary = "Unblock storage location", description = "Rate limit: **SENSITIVE_OPERATIONS**.")
@ApiResponse(
    responseCode = "200",
    content =
        @Content(
...
public @interface DocStorageLocationUnblock {}
