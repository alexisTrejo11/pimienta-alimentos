...
import io.github.alexistrejo11.pimienta.module.inventory.infrastructure.adapter.output.persistence.mapper.TransactionPersistenceMapper;
...
import io.github.alexistrejo11.pimienta.module.inventory.infrastructure.adapter.output.persistence.repository.jpa.InventoryTransactionJpaRepository;
import io.github.alexistrejo11.pimienta.module.inventory.infrastructure.adapter.output.persistence.specification.TransactionSpecifications;
...
public class InventoryTransactionRepositoryImpl implements InventoryTransactionRepository {
  ...
  public Optional<InventoryTransaction> findById(long id) {
    ...
    List<InventoryMovementJpaEntity> movementRows = movementJpaRepository.findByTransactionIdOrderByIdAsc(id);
    List<InventoryMovement> movements = movementRows.stream().map(movementMapper::toDomain).toList();
