...
@Operation(summary = "List payroll payments", description = "Returns payroll payment history.")
@ApiResponse(responseCode = "200", description = "Paged payroll payments.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PagedResponse.class)))
public @interface DocPayrollListPayments {}
