...
@Parameters({
  ...
  @Parameter(name = "periodId", in = ParameterIn.QUERY, description = "Filter by payroll period id.", example = "22"),
...
@Operation(summary = "List payroll records", description = "Returns filtered payroll records with pagination.")
@ApiResponse(
    responseCode = "200",
    description = "Paged payroll records.",
    content = @Content(mediaType = "application/json", schema = @Schema(implementation = PagedResponse.class)))
public @interface DocPayrollListRecords {}
