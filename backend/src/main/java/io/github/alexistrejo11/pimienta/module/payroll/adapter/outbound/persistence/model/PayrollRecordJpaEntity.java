...
@Table(
    ...
    indexes = {
      ...
      @Index(name = "idx_payroll_records_period_id", columnList = "period_id"),
      @Index(name = "idx_payroll_records_status", columnList = "status"),
      @Index(name = "idx_payroll_records_deleted_at", columnList = "deleted_at")
    })
