...
import io.github.alexistrejo11.pimienta.module.employees.core.domain.ReconstructEmployeeParams;

final class EmployeePersistenceMapper {

  private EmployeePersistenceMapper() {}

  static EmployeeJpaEntity toJpa(Employee domain) {
  ...
  static Employee toDomain(EmployeeJpaEntity e) {
